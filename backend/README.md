...
## Project Structure
    ...
    ├── testapiautostorybo_125356  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_125356`
...
2. Clone this repo and `cd testapiautostorybo_125356`
